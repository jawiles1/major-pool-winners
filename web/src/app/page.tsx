          ...
          <aside className="flex flex-col gap-5">
            ...
            >
              ...
              <p className="mt-5 text-base leading-7 text-foreground">
                Ryan Fox won the 2026 Open Championship at Royal Birkdale at
                10-under, one stroke ahead of Cameron Young.
              </p>
              <p className="mt-3 text-sm leading-6 text-muted">
                Fox was not on an active league roster, so the result created no
                payment obligations.
              </p>
              <p className="mt-3 text-sm leading-6 text-muted">
                All obligations generated by drafted 2026 winners are marked paid.
              </p>
            </section>
          </aside>
        </section>
