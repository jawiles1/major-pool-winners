...
export default function Season2028Page() {
  const seasonMajors = getSeasonMajors(majors, 2028);
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(255,250,240,0.97),_rgba(245,239,226,1)_42%,_rgba(226,214,184,0.98)_100%)]">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-8 px-5 py-6 sm:px-8 lg:px-10">
        <header className="overflow-hidden rounded-[2.5rem] border border-line bg-[linear-gradient(135deg,_rgba(72,45,23,0.97),_rgba(139,92,43,0.93)_54%,_rgba(215,189,132,0.82)_100%)] text-white shadow-[0_30px_90px_rgba(72,45,23,0.16)]">
          <div className="grid gap-8 px-6 py-8 sm:px-8 lg:grid-cols-[1.35fr_0.85fr] lg:px-10 lg:py-10">
            <div>
              ...
              <h1 className="mt-3 max-w-3xl text-4xl font-semibold tracking-tight sm:text-5xl">
                2028 closes the term, and the roadmap is already visible.
              </h1>
              <p className="mt-5 max-w-2xl text-sm leading-7 text-amber-50/88 sm:text-base">
                This season stub holds the future major schedule for the final
                year of the current league term. It is ready to become a live
                page when the league reaches the back end of the cycle.
              </p>
